...
if __name__ == "__main__":
    ...
    # Select colors
    palette = [(200, 200, 200, 255), (255, 0, 0, 255)]
    palette = [utils.colorRGB_256(color) for color in palette]  # Adjust color to Blender

    # Set background color of scene
    bpy.context.scene.world.node_tree.nodes["Background"].inputs[0].default_value = palette[0]
    ...
    # Render scene
    utils.render("validation_results", "tetrahedron_fractal", 500, 500, render_engine="CYCLES")
