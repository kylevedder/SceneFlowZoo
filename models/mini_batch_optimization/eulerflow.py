...
class EulerFlowModel(BaseOptimizationModel):
...
class EulerFlowOptimizationLoop(MiniBatchOptimizationLoop):
...
class EulerFlowNoKStepLossOptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowNoCycleConsistencyLossOptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowSincOptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowGaussianOptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowFourtierOptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowDepth22OptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowDepth20OptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowDepth18OptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowDepth16OptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowDepth14OptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowDepth12OptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowDepth10OptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowDepth4OptimizationLoop(EulerFlowOptimizationLoop):
...
class EulerFlowDepth2OptimizationLoop(EulerFlowOptimizationLoop):
